...
<body>
        ...
        <h1 style="margin-top:50px">GIỚI THIỆU CHUNG</h1>
    </div>
   
</div>
<div id="clip"  style=" margin-left:430px;margin-top:30px ">
<video width="600" height="400" controls="controls">
        <source src="video\it.mp4" type="video/mp4" />
</video>
<audio>
<source src="video\it.mp3" type="video/mpeg" />
</audio>
</div>
     <div id="gioithieu" style="width:1200px; margin:50px auto">
